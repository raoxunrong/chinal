...
<body>
<div align="center">
<form:form commandName="userVO" action="editUser" method="post" >
	<font color="red"><form:errors path="*" /></font>
	<table cellspacing="0" cellpadding="0" border="1" width="600">
		<tr>
			<td class="title" height="30" colspan="2" align="center">编辑用户信息</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="data" height="30"><select id="provinceId" onchange="getCities(this.options[this.selectedIndex].value)">
				<c:forEach items="${allProvince}" var="province">
					<c:choose>
						<c:when test="${defaultProvince.id == province.id}">
