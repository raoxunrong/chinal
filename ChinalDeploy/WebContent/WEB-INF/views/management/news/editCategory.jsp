...
<body>
<div align="center">
<form:form commandName="newsCategoryVO" action="editCategory" method="post" >
	<font color="red"><form:errors path="*" /></font>
	<table cellspacing="0" cellpadding="0" border="1" width="600">
		<tr>
			<td class="title" height="30" colspan="2" align="center">编辑新闻分类信息</td>
		</tr>
		<tr>
			<td class="title" height="30">分类名称：</td>
