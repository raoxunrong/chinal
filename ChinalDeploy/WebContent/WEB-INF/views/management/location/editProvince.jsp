...
<body>
<div align="center">
<form:form commandName="provinceVO" action="editProvince" method="post" >
	<font color="red"><form:errors path="*" /></font>
	<table cellspacing="0" cellpadding="0" border="1" width="600">
		<tr>
			<td class="title" height="30" colspan="2" align="center">编辑省份信息</td>
		</tr>
		<tr>
			<td class="title" height="30">省份名：</td>
