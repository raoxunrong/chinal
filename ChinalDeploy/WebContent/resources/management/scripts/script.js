...
write("<B style='cursor:hand;font:bold 16 宋体' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcIn' onMouseOut='this.style.color=0'>今天："+giYear+"年"+giMonth+"月"+giDay+"日</B>");
write("</TD></TR>");
write("</TABLE></Div>");
